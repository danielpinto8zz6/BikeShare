...
public sealed class RentalStateMachine : MassTransitStateMachine<RentalState>
{
    ...
    public RentalStateMachine(ILogger<RentalStateMachine> logger)
    {
        _logger = logger;
    ...
    private EventActivityBinder<RentalState, IRentalSubmitted> SetRentalSummitedHandler() =>
        When(RentalSubmitted)
            ...
            .ThenAsync(c => SendCommand<IValidateBike>("rabbitmq://192.168.1.200/bike-validate", c))
    ...
    private EventActivityBinder<RentalState, IBikeValidated> SetBikeValidatedHandler() =>
        When(BikeValidated)
            ...
            .ThenAsync(c => SendCommand<IReserveBike>("rabbitmq://192.168.1.200/bike-reservation", c));
    ...
    private EventActivityBinder<RentalState, IBikeReserved> SetBikeReservedHandler() =>
        When(BikeReserved)
            ...
            .ThenAsync(c => SendCommand<IUnlockBike>("rabbitmq://192.168.1.200/bike-unlock", c));
